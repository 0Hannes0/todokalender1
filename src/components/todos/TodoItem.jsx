export function TodoItem({ todo, onToggle, onDelete }) {
  return (
    <div className={`flex items-center gap-2.5 px-2 py-2.5 rounded-xl group transition-colors hover:bg-surface-2 active:bg-surface-2 ${todo.completed ? 'opacity-50' : ''}`}>
